...
def suite : InstrSuite where
  ...
  oracle := #[
    ...
    mkShiftStackCase "/range/immediate-overmax" 257 #[intV 7, intV 3],
    mkShiftStackCase "/error-order/range-before-y-type-invalid-immediate" 257 #[intV 7, .null],
    mkShiftStackCase "/error-order/range-before-x-type-invalid-immediate" 257 #[.null, intV 7],
