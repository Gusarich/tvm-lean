...
private def createdBitsForAdd (root : Option Cell) (bits : BitString) : Nat :=
  ...
  | .error e =>
      panic! s!"DICTUADDGETB: cannot precompute create count: {reprStr e}"
...
private def genDictAddGetBFuzzCase (rng0 : StdGen) : OracleCase × StdGen :=
  ...
  let (case0, rng3) :=
    ...
    | 5 =>
        (mkDictAddGetBCase
          "fuzz/int-signed-hit"
          (mkDictCaseIntStack valueA 7 (.cell dictSigned4) 4) #[instrSigned], rng2)
    | 6 =>
        (mkDictAddGetBCase
          "fuzz/int-signed-miss"
          (mkDictCaseIntStack valueA 2 (.cell dictSigned4) 4) #[instrSigned], rng2)
    | 7 =>
        (mkDictAddGetBCase
          "fuzz/int-unsigned-hit"
          (mkDictCaseIntStack valueA 255 (.cell dictUnsigned8) 8) #[instrSignedUnsigned], rng2)
    | 8 =>
        (mkDictAddGetBCase
          "fuzz/int-unsigned-miss"
          (mkDictCaseIntStack valueA 7 (.cell dictUnsigned8) 8) #[instrSignedUnsigned], rng2)
    | 9 =>
        (mkDictAddGetBCase
          "fuzz/key-too-short"
    ...
    | 13 =>
        (mkDictAddGetBCase
          ...
          (mkDictCaseIntStack valueA 8 (.cell dictSigned4) 4) #[instrSigned], rng2)
    | 14 =>
        (mkDictAddGetBCase
          "fuzz/key-int-out-of-range/unsigned"
          (mkDictCaseIntStack valueA (-1) (.cell dictUnsigned8) 8) #[instrSignedUnsigned], rng2)
    | 15 =>
        (mkDictAddGetBCase
