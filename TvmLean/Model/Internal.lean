...
def ed25519Verify (_msg _pk _sig : ByteArray) : Bool := false

def secp256k1Ecrecover (_hash _sig : ByteArray) : ByteArray := ByteArray.mk #[]

def secp256k1XonlyPubkeyTweakAdd (_key _tweak : ByteArray) : ByteArray := ByteArray.mk #[]

def p256Verify (_data _pk _sig : ByteArray) : Bool := false

def rist255FromHash (_x1 _x2 : ByteArray) : ByteArray := ByteArray.mk #[]

def rist255IsValidPoint (_x : ByteArray) : Bool := false

def rist255AddBytes (_x _y : ByteArray) : ByteArray := ByteArray.mk #[]

def rist255SubBytes (_x _y : ByteArray) : ByteArray := ByteArray.mk #[]

def rist255MulBytes (_nLe _x : ByteArray) : ByteArray := ByteArray.mk #[]

def rist255MulBaseBytes (_nLe : ByteArray) : ByteArray := ByteArray.mk #[]

def blsVerify (_pub _msg _sig : ByteArray) : Bool := false

def blsAggregate (_sigs : Array ByteArray) : ByteArray := ByteArray.mk #[]

def blsFastAggregateVerify (_pubs : Array ByteArray) (_msg _sig : ByteArray) : Bool := false

def blsAggregateVerify (_pubs _msgs : Array ByteArray) (_sig : ByteArray) : Bool := false

def blsG1AddBytes (_a _b : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1SubBytes (_a _b : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1NegBytes (_a : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1MulBytes (_p _x : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1MultiExpBytes (_ps _xs : Array ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1ZeroBytes (_ : Unit) : ByteArray := ByteArray.mk #[]

def blsMapToG1Bytes (_a : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG1InGroup (_a : ByteArray) : Bool := false

def blsG1IsZero (_a : ByteArray) : Bool := false

def blsG2AddBytes (_a _b : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2SubBytes (_a _b : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2NegBytes (_a : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2MulBytes (_p _x : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2MultiExpBytes (_ps _xs : Array ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2ZeroBytes (_ : Unit) : ByteArray := ByteArray.mk #[]

def blsMapToG2Bytes (_a : ByteArray) : ByteArray := ByteArray.mk #[]

def blsG2InGroup (_a : ByteArray) : Bool := false

def blsG2IsZero (_a : ByteArray) : Bool := false

def blsPairing (_p1s _p2s : Array ByteArray) : UInt8 := 0

def hashSha256 (_data : ByteArray) : ByteArray := ByteArray.mk #[]

def hashSha512 (_data : ByteArray) : ByteArray := ByteArray.mk #[]

def hashBlake2b (_data : ByteArray) : ByteArray := ByteArray.mk #[]

def hashKeccak256 (_data : ByteArray) : ByteArray := ByteArray.mk #[]

def hashKeccak512 (_data : ByteArray) : ByteArray := ByteArray.mk #[]
